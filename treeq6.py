...
def traverse(p,order=2):
    if order == 1: print(tree[p].data,end=chr(0x20))
    if tree[p].left != -1:
        traverse(tree[p].left)
    #end if
    if order == 2: print(tree[p].data,end=chr(0x20))
    if tree[p].right != -1:
        traverse(tree[p].right)
    #end if
    if order == 3: print(tree[p].data,end=chr(0x20))
...
#         traverse(tree[p].left)
#     #end if
#     print(tree[p].data,end=chr(0x20))
#     if tree[p].right != -1:
#         traverse(tree[p].right)
#     #end if
# #end procedure